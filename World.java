...
public class World {
    ...
    public Dictionary<String, Bird[]> countByColor(Bird[] birds) {
    ...
    public Dictionary<String, Bird[]> countByDiet(Bird[] birds){
        Dictionary<String, Bird[]> result = new Hashtable<>();
        for(Bird bird : birds) {
    ...
    public Dictionary<String, Bird[]> countByStatus(Bird[] birds){
        Dictionary<String, Bird[]> result = new Hashtable<>();
        for(Bird bird : birds) {
